...
/**
 * The persistent class for the SYS_AC_BALANCE_YEAR database table.
 * 
 */
@Entity
@Table(name = "SYS_AC_BALANCE_YEAR")
@Data
@EqualsAndHashCode(callSuper = false)
@AllArgsConstructor
@NoArgsConstructor
public class SysAcBalanceYear {

    @Id
    @Column(name = "YEARLY_AC_BALANCE_ID", unique = true, nullable = false, precision = 15)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "YEARLY_AC_BALANCE_SEQ")
    @TableGenerator(name = "YEARLY_AC_BALANCE_SEQ", table = "TABLE_SEQ", pkColumnName = "SEQ_NAME",
        pkColumnValue = "YEARLY_AC_BALANCE_ID", valueColumnName = "SEQ_CNT", allocationSize = 1)
    private long yearlyAcBalanceId;
