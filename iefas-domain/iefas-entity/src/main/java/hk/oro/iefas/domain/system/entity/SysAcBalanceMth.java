...
/**
 * The persistent class for the SYS_AC_BALANCE_MTH database table.
 * 
 */
@Entity
@Table(name = "SYS_AC_BALANCE_MTH")
@Data
@EqualsAndHashCode(callSuper = false)
@AllArgsConstructor
@NoArgsConstructor
public class SysAcBalanceMth {

    @Id
    @Column(name = "MONTHLY_AC_BALANCE_ID", unique = true, nullable = false, precision = 15)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "MONTHLY_AC_BALANCE_SEQ")
    @TableGenerator(name = "MONTHLY_AC_BALANCE_SEQ", table = "TABLE_SEQ", pkColumnName = "SEQ_NAME",
        pkColumnValue = "MONTHLY_AC_BALANCE_ID", valueColumnName = "SEQ_CNT", allocationSize = 1)
    private long monthlyAcBalanceId;
