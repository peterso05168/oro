...
@NoArgsConstructor
@AllArgsConstructor
public class CalculationOfDividendFeeVO extends TxnVO {
    ...
    private List<CaseFeeForDividendCalculationVO> caseFeeForDividendCalculations;
    private String caseFeeTypeName;
    private List<DistributedAmountVO> distributedAmounts;
