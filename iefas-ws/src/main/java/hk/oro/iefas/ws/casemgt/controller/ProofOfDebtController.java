...
@Slf4j
@RestController
@RequestMapping(value = RequestUriConstant.URI_ROOT_PROOF_OF_DEBT)
public class ProofOfDebtController {
    ...
    public Page<SearchProofOfDebtResultDTO>
        ...
        Page<SearchProofOfDebtResultDTO> debtList = proofOfDebtService.findByCriteria(criteria);
